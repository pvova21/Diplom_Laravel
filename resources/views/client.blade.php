...
<body>
  ...
  <main>
    <section class="movie">
      <div class="movie__info">
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Звёздные войны постер" src="{{Vite::asset('resources/client/i/poster1.jpg') }}">
        </div>
    ...
    <section class="movie">
      <div class="movie__info">      
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Альфа постер" src="{{Vite::asset('resources/client/i/poster2.jpg') }}">
        </div>
        <div class="movie__description">        
    ...
    <section class="movie">
      <div class="movie__info">      
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Хищник постер" src="{{Vite::asset('resources/client/i/poster2.jpg') }}">
        </div>
        <div class="movie__description">        
      ...
      <div class="movie-seances__hall">
        ...
        <ul class="movie-seances__list">
          ...
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">14:50</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">16:30</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">18:00</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">18:50</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">19:50</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">20:55</a></li>
          <li class="movie-seances__time-block"><a class="movie-seances__time" href="hall">22:00</a></li>
        </ul>
      </div>     
    </section>     
